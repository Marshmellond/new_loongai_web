      ...
      >
        <a-menu v-model:selectedKeys="counter.selectedKeys" theme="light" mode="inline" style="width: 100px;border: 0">
          ...
          <a-menu-item key="102">
            <icon :style="{ color: '#8994a6'}" class="icon-ai-blue">
              <template #component>
                <svg t="1722762737836" class="icon" viewBox="0 0 1024 1024" version="1.1"
                     xmlns="http://www.w3.org/2000/svg" p-id="4307" width="14" height="14">
                  <path
                      d="M876.76 729.59c-4.97 0-9.89 0.25-14.74 0.73-4.64-3.08-9.27-7.78-14.03-15.03L691.2 512l167.18-218.44c6.02 0.75 12.16 1.14 18.38 1.14 81.19 0 147-65.81 147-147S957.95 0.7 876.76 0.7s-147 65.81-147 147c0 51.35 26.34 96.55 66.24 122.83l-144 196.3-128.8-173.18c-11.2-15.06-28-15.06-39.2 0L360.8 459.29 219.71 275.92c44.79-25.19 75.06-73.16 75.06-128.21 0-81.19-65.81-147-147-147s-147 65.81-147 147 65.81 147 147 147c1.81 0 3.62-0.04 5.41-0.11L316 512 159.2 722.82c-2.36 2.67-4.6 5.09-6.74 7.29-1.81-0.07-3.63-0.11-5.46-0.11C65.81 730 0 795.81 0 877s65.81 147 147 147 147-65.81 147-147c0-55.02-30.23-102.97-74.99-128.17 2.13-3.13 4.57-6.75 7.39-10.94l128.8-173.18 84 106.3c-47.19 24.47-79.44 73.75-79.44 130.58 0 81.19 65.81 147 147 147s147-65.81 147-147c0-60.24-36.24-112-88.1-134.71l80.74-102.17 134.4 180.7c3.89 5.23 7.07 9.17 9.72 12.13-36.81 26.72-60.76 70.08-60.76 119.04 0 81.19 65.81 147 147 147s147-65.81 147-147-65.81-146.99-147-146.99z m0.5-665.88c46.12 0 83.5 37.38 83.5 83.5s-37.38 83.5-83.5 83.5-83.5-37.38-83.5-83.5 37.39-83.5 83.5-83.5z m-729 0c46.12 0 83.5 37.38 83.5 83.5s-37.38 83.5-83.5 83.5-83.5-37.38-83.5-83.5 37.39-83.5 83.5-83.5zM147.5 960c-46.12 0-83.5-37.38-83.5-83.5s37.38-83.5 83.5-83.5 83.5 37.38 83.5 83.5-37.38 83.5-83.5 83.5z m359.76-75.41c-46.12 0-83.5-37.38-83.5-83.5s37.38-83.5 83.5-83.5 83.5 37.38 83.5 83.5-37.38 83.5-83.5 83.5z m-0.53-230c-0.23 0-0.45 0.01-0.68 0.01L400 512l106.4-143.06L607.2 512 506.73 654.59z m370.53 305c-46.12 0-83.5-37.38-83.5-83.5s37.38-83.5 83.5-83.5 83.5 37.38 83.5 83.5-37.38 83.5-83.5 83.5z"
                      p-id="4308"></path>
                </svg>
              </template>
            </icon>
            <span class="nav-text"><RouterLink to="/data">数据</RouterLink></span>
          </a-menu-item>
          <a-menu-item key="1">
            <CommentOutlined/>
          ...
          <a-menu-item key="34">
            <icon :style="{ color: '#8994a6'}" class="icon-ai-blue">
              <template #component>
                <svg t="1722764676922" class="icon" viewBox="0 0 1024 1024" version="1.1"
                     xmlns="http://www.w3.org/2000/svg" p-id="8569" width="14" height="14">
                  <path
                      d="M611.147 769.084a25.239 25.239 0 0 1 0-38.31 32.527 32.527 0 0 1 42.647 0l212.932 191.67a25.239 25.239 0 0 1 0 38.309 32.527 32.527 0 0 1-42.587 0L611.147 769.084z m-240.94-38.31a32.527 32.527 0 0 1 42.646 0 25.239 25.239 0 0 1 0 38.31L199.86 960.753a32.527 32.527 0 0 1-42.587 0 25.239 25.239 0 0 1 0-38.31l212.932-191.668z"
                      fill="#333333" p-id="8570"></path>
                  <path
                      d="M150.588 60.235a60.235 60.235 0 0 0-60.235 60.236v542.117a60.235 60.235 0 0 0 60.235 60.236h722.824a60.235 60.235 0 0 0 60.235-60.236V120.471a60.235 60.235 0 0 0-60.235-60.236H150.588z m0-60.235h722.824a120.47 120.47 0 0 1 120.47 120.47v542.118a120.47 120.47 0 0 1-120.47 120.47H150.588a120.47 120.47 0 0 1-120.47-120.47V120.471A120.47 120.47 0 0 1 150.588 0z"
                      fill="#333333" p-id="8571"></path>
                  <path
                      d="M843.294 512a30.118 30.118 0 0 1 0 60.235H662.588a30.118 30.118 0 0 1 0-60.235h180.706z m0-150.588a30.118 30.118 0 0 1 0 60.235H662.588a30.118 30.118 0 0 1 0-60.235h180.706z m0-150.588a30.118 30.118 0 0 1 0 60.235H662.588a30.118 30.118 0 1 1 0-60.235h180.706zM210.824 391.53a120.47 120.47 0 0 0 224.798 60.235H271.059V287.202a120.47 120.47 0 0 0-60.235 104.327z m120.47-180.706v180.705H512a180.706 180.706 0 1 1-180.706-180.705z"
                      fill="#333333" p-id="8572"></path>
                  <path d="M542.118 361.412a180.706 180.706 0 0 0-180.706-180.706v180.706h180.706z" fill="#333333"
                        p-id="8573"></path>
                </svg>
              </template>
            </icon>
            <span class="nav-text"><RouterLink to="/study">学情</RouterLink></span>
          </a-menu-item>
          <a-menu-item key="200">
            <user-outlined/>
