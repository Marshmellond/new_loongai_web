...
watch(() => counter.app_alter_mod_open, () => {
  formState.chat_mod_name = counter.app_alter_mod_data[1]
  formState.chat_mod_label = counter.app_alter_mod_data[3]
  formState.chat_mod_desc = counter.app_alter_mod_data[4]
  formState.chat_mod_system = counter.app_alter_mod_data[5]
})
...
const onClose = () => {
  counter.app_alter_mod_open = false;
};
const get_data = () => {
...
const onFinish = (values: any) => {
  const url = "/api/app/alter_user_mod"
  let body = {
    chat_mod_id: counter.app_alter_mod_data[0],
...
<template>
  <a-drawer
      title="修改应用信息"
      :width="540"
      :open="counter.app_alter_mod_open"
