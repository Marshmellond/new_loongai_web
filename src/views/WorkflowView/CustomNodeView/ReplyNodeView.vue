    ...
    <div class="div1">
      <div class="div1-ico">
        <icon :style="{ color: '#000000'}">
          <template #component>
            <svg t="1719994529567" class="icon" viewBox="0 0 1099 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 p-id="12692" width="20" height="20">
              <path
