    ...
    <div class="div4">
      ...
      <div class="div4-utils">
        <div class="div4-microphone">
          <AudioOutlined v-if="!microphone_status" class="div4-microphone1" @click="seed_microphone"/>
          <icon :style="{ color: '#000000'}" v-if="microphone_status" class="div4-microphone2"
                @click="seed_microphone_stop">
            <template #component>
...
.div4 {
  ...
  .div4-utils {
    ...
    .div4-seed {
      ...
      left: 59vw;
      top: 1vh;
      padding: 0.01vh 1.5vh 0.01vh 1.5vh;
